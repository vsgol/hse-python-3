...
def main():
    ...
    sync_time = run_sync(fibonacci, n, workers_num)
    threads_time = run_workers(fibonacci, n, workers_num, Thread)
    process_time = run_workers(fibonacci, n, workers_num, Process)
